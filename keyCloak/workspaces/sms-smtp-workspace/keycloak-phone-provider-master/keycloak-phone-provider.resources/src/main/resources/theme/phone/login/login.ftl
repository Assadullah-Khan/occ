...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password','code','phoneNumber') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
 ...
 <#if locale.currentLanguageTag=="ar">body {
direction: rtl;
}
...
padding: 0px 0px 0px 5px !important;
        ...
        <div id="vue-app" <#if locale.currentLanguageTag=="ar"> class="ar-form"
        </#if>>
            <div v-cloak>
                    ...
                    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                        ...
                        <#if !usernameHidden?? && supportPhone??>
                            ...
                            <input type="hidden" id="phoneActivated" name="phoneActivated" v-model="phoneActivated" value="true">
                       </#if>
                        ...
                        <#if !usernameHidden?? && supportPhone??>
                            <div v-if="phoneActivated">
                                <div class="${properties.kcFormGroupClass!}">
                                    <label for="phoneNumber" class="${properties.kcLabelClass!}">${msg("phoneNumber|email")}</label>
        ...
        <#if !usernameHidden?? && supportPhone??>
            <script type="text/javascript">
                ...
                function req(phoneNumber) {
                    ...
                    const language = kcLocale ? kcLocale : (document.getElementById ('kc-page-title').innerText === 'تسجيل' ? 'ar' : 'en')
