...
public interface PhoneProvider extends Provider {
    ...
    void sendAction(String phoneNumber,ActionsEnums action);

    int sendTokenCode(String phoneNumber, String sourceAddr, TokenCodeType type, String kind, String language);
