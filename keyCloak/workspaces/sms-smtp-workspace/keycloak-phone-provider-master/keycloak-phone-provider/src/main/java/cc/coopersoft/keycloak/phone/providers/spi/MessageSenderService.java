...
public interface MessageSenderService extends Provider {
   ...
   void sendAction(String phoneNumber,ActionsEnums action) throws MessageSendException;

    void sendSmsMessage(TokenCodeType type, String phoneNumber, String code , int expires , String kind, String language) throws MessageSendException;
